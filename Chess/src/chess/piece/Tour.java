...
public class Tour extends Piece{
	...
	public Tour(Color color, int xPos, int yPos)
	 {
		 ...
		 {
	 ImageView i = new ImageView(getClass().getResource("tourBlack.png").toString());
	 image = i;
		 }else {
 ImageView i = new ImageView(getClass().getResource("tourWhite.png").toString());
 image = i;
 }
	 }
